...
3 - Podemos, em uma função, retornar qualquer tipo de de dado e até mesmo múltiplos valores;
...
# Exemplo 2 - Podemos ter, em um função, diferentes returns;
...
# Exemplo 3 - Podemos, em uma função, retornar qualquer tipo de de dado e até mesmo múltiplos valores;
...
# Erros comuns na utilização do retorno, que na verdade nem é erro, mas sim codificação desnecessára.
