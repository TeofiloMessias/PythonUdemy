...
# OBS: O zip() utiliza como parãmentro o menor tamanaho em iterável. Isso significa que se estiver
# trabalhando com iteraveis de tamanhaos diferentes, ira para quando os elementos do menor
# iterável acabar
