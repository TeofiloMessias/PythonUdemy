...
costumamos a criar método publicos para manipulação desses atributos.Esses métodos
são conhecidos por getters e setters, onde os getters retornam o valor do atributo
e o setters alteram o valor do mesmo.
...
# soma = conta1._Conta__saldo + conta2._Conta__saldo -> Forma errada de pegar os dados da conta
...
class Conta:
    ...
    @limite.setter
    def limite(self, movo_limite):
        self.__limite = movo_limite
