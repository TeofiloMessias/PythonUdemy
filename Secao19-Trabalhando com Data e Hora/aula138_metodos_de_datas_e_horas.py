...
manutencao = datetime.datetime.combine((datetime.datetime.now() + datetime.detidelta(days=1)), datetime.time())
...
aniversario = input('Qual sua data de aniversario ? dd/mm/yyyy: ')
...
hoje_formatado = hoje.strftime('%d/%m/%Y') # ('%d/%B/%Y') ou ('%d/%b/%Y')

print(hoje_formatado)

def formata_dada(data):
    if data.month == 1:
