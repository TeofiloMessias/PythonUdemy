...
# Em Python, podemos fazer isso em diferentes IDEs, como o Pycharme ou utilizando
...
# no inicio do arquivo. Por isso, ao invez de colocamos o import do pdb no inicio do arquivo,
# nós colocamos somente aonde debuggar, e ao finalizar ja fazemos a remoção
...
print(final)
"""
# OBS: Cuidado com conflitos entre nomes de variaveis e os comandos pdb
...
#  Como os nomes das variaveis são os mesmos dos comandos do pdb, devemos utilizar o comando 'p'
